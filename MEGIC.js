...
function checkAnswer(){
	...
	if(a){
		...
		document.getElementById("answer1").style.visibility="visible";
		document.getElementById("answer1").innerHTML="ncorrect. Noises auscultated over the lung fields on respiration. Types include vesicular (normal), bronchial and tracheal.";
		document.getElementById("nextQuestion").style.visibility="visible";
	}
}
